...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        //id = 1010 : Stage2 Fairy3
        talkData.Add(1010, new string[] { "바로 앞에 적들이 있는 것 같아요! ", "조심하세요!"});

        //id = 1011 : Stage2 Fairy4
        talkData.Add(1011, new string[] { "여태껏 모아오신 물약들..", "몸의 크기를 조절하는 물약의 재료인 것 같아요!",
            "그냥 먹었을 때에는 특별한 변화는 없는 것 같아요."});

        //id = 1012 : Stage2 Fairy5
